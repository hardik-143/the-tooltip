...
const Colored = () => {
  const arr = ["red", "lime", "yellow", "orange", "blue", "cyan","magneta","silver","grey","maroon","olive","green","purple","teal"];
  return <>
  <section>
    <a href="#colored" className="section-title"># Colored</a>
    <p className="section-secondary-title">
        For Colored tooltip, you can use{" "}   
        <span className="tag bordered">data-ttooltip-color</span>{" "}
        attribute. <br />
